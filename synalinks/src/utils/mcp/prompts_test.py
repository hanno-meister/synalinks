...
# from synalinks import ChatMessage
# from synalinks import ChatRole
...
#     def test_convert_mcp_prompt_message_to_synalinks_message_with_text_content_assistant(
#         self,
#     ):
...
#     def test_convert_mcp_prompt_message_to_synalinks_message_with_resource_content_assistant(
#         self,
#     ):
#         message = PromptMessage(
#             role="assistant",
...
#     def test_convert_mcp_prompt_message_to_synalinks_message_with_resource_content_user(
#         self,
#     ):
#         message = PromptMessage(
#             role="user",
...
#     def test_convert_mcp_prompt_message_to_synalinks_message_with_image_content_assistant(
#         self,
#     ):
#         message = PromptMessage(
#             role="assistant",
#             content=ImageContent(
#                 type="image", mimeType="image/png", data="iVBORw0KGgoAA..."
#             ),
#         )
...
#     def test_convert_mcp_prompt_message_to_synalinks_message_with_image_content_user(
#         self,
#     ):
#         message = PromptMessage(
#             role="user",
