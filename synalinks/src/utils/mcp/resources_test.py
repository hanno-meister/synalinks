...
# )
# from synalinks.src.utils.mcp.resources import get_mcp_resource
...
#                         uri=uri, mimeType="text/plain", text="Content 1"
#                     ),
#                     TextResourceContents(
#                         uri=uri, mimeType="text/plain", text="Content 2"
#                     ),
#                 ]
#             )
#         )
...
#                 contents=[
#                     TextResourceContents(
#                         uri=uri, mimeType="text/plain", text="Hello Text"
#                     ),
